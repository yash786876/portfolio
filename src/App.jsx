...
import DCFModel from './pages/DCFModel.jsx'
    ...
    <>
      ...
      <main>
        <Routes>
          ...
          <Route path="/finance-geek/dcf-model" element={<DCFModel />} />
          <Route path="/finance-geek/industry-analysis" element={<IndustryAnalysis />} />
          {TOPIC_PAGES.map((t) => (
